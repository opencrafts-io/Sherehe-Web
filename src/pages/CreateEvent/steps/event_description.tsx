...
function EventDescription({
    ...
    return (
        <>
            <div>
                <h1 className='text-4xl my-2 font-bold'>Event Description & Genres</h1>
                    ...
                    <div className="flex justify-between">
                        <div className="flex flex-col gap-3">
                            <div className="flex gap-4 items-center">
                                ...
                                <h2 className="text-lg font-bold">Event Genres & Description</h2>
                            ...
                            <p className="text-base text-gray-600">Select upto 20 genres that best represent your event</p>
                        </div>
                        <button
                            type="button"
